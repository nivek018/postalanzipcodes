<div class="mt-8 mb-4">
    ...
    x-data='{
        init() {
            $nextTick(() => {
                new Swiper(this.$refs.homeOfferSlider, {
                    loop: false,
    ...
    >
        ...
        <div x-ref="homeOfferSlider" class="swiper block relative group w-full h-auto">
            ...
            <ul class="swiper-wrapper" id="offersList">
                <li class="swiper-slide flex flex-col items-center justify-center">
                    <a href="https://shope.ee/8zWtQtYwc9" class="relative rounded-sm overflow-hidden">
                        <img class="object-contain w-fit h-full aspect-auto"
