<div class="mt-4 mb-4">
    ...
    >
        ...
        <div x-ref="homeOfferSlider" class="swiper block relative group w-full h-auto max-h-[180px] overflow-hidden">

            {{--slider items wrapper --}}
            <ul class="swiper-wrapper flex flex-row" id="offersList">
                <li class="swiper-slide flex flex-col items-center justify-center">
                    <a href="https://shope.ee/8zWtQtYwc9" class="relative rounded-sm overflow-hidden" title="Shopee MAS MURA Home Appliances" aria-label="Shopee MAS MURA Home Appliances">
                        <img class="lazy object-contain w-fit h-fit lg:max-w-[680px] lg:max-h-[180px] aspect-auto"
