    ...
    <form id="search-form" autocomplete="off">
        ...
        <div class="mx-auto w-full md:w-4/5 h-full flex-auto">
            <div class="relative mt-1 flex items-center">
                <input
                    class="transition-all ease-in-out duration-300 block w-full rounded-full text-white bg-gray-900 border-gray-600 text-xl py-5 px-8 pr-16 shadow-sm outline-none ring-2 focus:ring-offset-blue-700 focus:ring-offset-2 focus:border-blue-500 focus:ring-blue-500 focus:bg-gray-100 focus:text-gray-900"
