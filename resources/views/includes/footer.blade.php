        ...
        <div class="lg:flex lg:items-center lg:justify-between">
            <div class="md:max-w-lg">
                <a href="https://postalandzipcodes.ph/" class="flex items-center mb-4 sm:mb-0">
                    <img src="https://res.cloudinary.com/mnoquiao/image/upload/f_auto,q_auto,w_80,h_80/v1601874637/postalandzipcodes.ph/square-logo.svg" class="h-12 mr-3" alt="postalandzipcodes.ph" />
...
<a href="https://shope.ee/8pDVmnJsEG" target="_blank" class="fixed right-0 bottom-0 z-[9999] w-20 mr-4 mb-4 md:w-40 md:mr-4 md:mb-10">
    <img class="lazy w-fit h-fit lg:max-w-[130px] lg:max-h-[130px]" src="{{ asset('image/shopee-click.gif') }}" alt="" srcset="">
</a>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    Your support is crucial in helping us maintain and improve our site. With your donation, we can continue to provide valuable resources and services to our users. Every little bit helps and we deeply appreciate your generosity.
                </p>

                <div class="flex flex-col md:flex-row md:justify-between border rounded border-gray-500 p-4 space-y-6 md:space-y-0 md:space-x-4">
                    <div>
