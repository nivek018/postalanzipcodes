        ...
        <div class="row">
            <div class="col-lg-6 col-md-5 col-sm-4 text-center text-sm-left">
                <a href="/" class="site-logo" style="text-decoration:none; color:#000;">
                    <img loading="lazy" src="https://res.cloudinary.com/mnoquiao/image/upload/q_auto,f_auto/v1576734741/postalandzipcodes.ph/POSTALANDZIPCODES_LOGO.png" class="img-fluid" width="200px" alt="postalandzipcodes.ph logo">
                </a>
            </div> <!-- END .col-lg-6 -->
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                <div class="footer-widget widget-about">
                  ...
                  <ul class="footer-list-menu">
                    <li><a href="/what-is-my-zip-code" title="Get your current location's zip code information.">How it Works</a></li>
