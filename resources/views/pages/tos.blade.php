    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="w-full mt-4 p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <section class="font-normal dark:text-gray-400">
                ...
                Welcome to postalandzipcodes.ph, a Brand Media company. By using our web services, you agree and accept the following terms and conditions ("Terms Of Service").
                ...
                Any attempts to undermine or cause harm to our servers or customers are strictly prohibited. postalandzipcodes.ph, a Brand Media company, will not permit you to use our services for any of the following purposes. Doing so violates the terms of your agreement with us:
                ...
                Brand Media, Inc. may contain links to third party websites, which are not under the control of postalandzipcodes.ph. We are not responsible for the contents contained in the linked sites, including without limitation any link contained in a linked site, and any changes or updates to a linked site.
                ...
                <p>This agreement shall be governed by and interpreted and enforced in accordance with the laws of the state of Illinois applicable therein without reference to rules governing the choice of laws. Any action relating to this agreement must be brought exclusively in the United States District Court for Northern District of Illinois, or if there is no jurisdiction in such court, then in a state court in Cook County, and you irrevocably consent to the jurisdiction of such courts.</p>
