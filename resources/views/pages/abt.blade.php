        ...
        <section class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div
                ...
                <p class="text-sm dark:text-gray-800 font-bold font-Inter">
                    You may also want to check my other projects <a href="https://pcsolotto.io/"
                        target="_blank" title="Visit PCSOLotto.io for daily lotto results"
                        class="font-bold underline">PCSOLotto.io<svg class="inline-flex w-3 h-3" fill="currentColor"
