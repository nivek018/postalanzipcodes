    ...
    <div class="relative overflow-hidden py-10 md:py-5">
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="w-full lg:max-w-lg mx-auto mt-4">
                ...
                <div
                    class="p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <form id="submit-zip-code-form" autocomplete="off" class="space-y-6">
                        @csrf()

                        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Sign in to our platform</h5>
                        <div class="text-gray-200">{{ $data['description'] }}</div>
                        ...
                        <div class="mb-6">
                            <label for="countries"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select the
                                Region</label>
                        ...
                        <div class="mb-6 w-[50%]">
                            ...
                            <input type="text" name="zipcode" id="inputZipcode" minlength="4" maxlength="8"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                        </div>
                        ...
                        <div class="mb-6">
                            <label for="inputName"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Display Name <small
                        ...
                        <div class="mb-6">
                            <label for="inputEmail"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email Address <small
                                    class="text-muted">(Optional)</small></label>
                        ...
                        <button type="submit" id="submit-zip-code-btn"
                            class="dark:disabled:bg-gray-700 disabled:text-gray-500 disabled:cursor-wait
