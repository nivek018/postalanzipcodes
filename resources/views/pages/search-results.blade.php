            ...
            <div class="col-xl-12">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container text-center">
                        ...
                        <p class="lead no-margin">No results were found for 😭 <u class="font-weight-bold">{{ $search_q }}</u>.</p>
                        ...
                        <small class="text-muted d-block">
                            But you can help us <u class="font-weight-bold">improve our records</u> by giving us <br> more details about <u class="font-weight-bold">{{ $search_q }}</u>, it'll only take you 😘 1 minute 💪.
                        </small>
                    </div>
                </div>
            </div> <!-- [ .col-xl-12 ] END -->
